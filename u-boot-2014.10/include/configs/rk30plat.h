...
#define CONFIG_WARP_LOAD_ADDR	CONFIG_SYS_LOAD_ADDR
#define CONFIG_WARP_SAVENO	0

#define WARP_PART_NAME		"warp"

#ifdef WARP_NONE_FLOATING

#define WARP_HIBDRV_PHYS	(CONFIG_SYS_LOAD_ADDR + 0x04100000)
