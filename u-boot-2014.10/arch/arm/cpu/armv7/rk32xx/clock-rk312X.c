...
static const struct pll_clk_set apll_clks[] = {
	...
	_APLL_SET_CLKS(1200000, 1, 50, 1, 1, 1, 0,	1, 2, 8, 4, 2, 2),
	_APLL_SET_CLKS(1110000, 1, 185, 4, 1, 1, 0,	1, 2, 8, 4, 2, 2),
	_APLL_SET_CLKS(1104000, 1, 46, 1, 1, 1, 0,	1, 2, 8, 4, 2, 2),
	_APLL_SET_CLKS(1008000, 1, 84, 2, 1, 1, 0,	1, 2, 8, 4, 2, 2),
...
#ifdef CONFIG_WARP
void warp_set_clock(void)
{
	rkclk_pll_set_rate(APLL_ID, 816, rkclk_apll_cb);
}
#endif
